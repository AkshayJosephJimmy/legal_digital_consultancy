...
function ServiceCards({service,onClick}) {
    ...
    return(
        <div className="bg-neutral-100 h-60shadow-lg rounded-4xl hover:bg-neutral-500 hover:translate-y-1 transition-all duration-200 w-150 lg:h-80  " onClick={onClick}>
